...
?>
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="admin/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>" alt="" class="img-fluid">
              </div>
              ...
              <div class="entry-meta">
                <ul>
                  ...
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <span><?php $d = strtotime($row['postingdate']);
                        ?><time datetime="2020-01-01"><?php echo date("Y-d-M", $d); ?></time></span></li>
                  <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i>
            <?php 
            $pid= $row['pid'];
            $comment_result = mysqli_query($con, "SELECT * FROM comments WHERE postsid = '$pid'");
            $c_count = mysqli_num_rows($comment_result);
            ?>
              <?php 
               $pid= $row['pid'];
              ...
              $r_count = mysqli_num_rows($c_result);               
                ?>
                <span><?php $allcount = $c_count + $r_count ; echo $allcount; ?> comments</span></li>
                </ul>
              </div>
