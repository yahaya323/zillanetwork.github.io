            ...
            <div class="col-lg-10 col-sm-9">
              ...
              <ul>
                ...
                if($row = mysqli_fetch_array($result)){
                    ...
                    <a class="active" href="ask-question"><i class="fa fa-edit"></i>Ask New Question</a>
            ...
            <div class="col-lg-6">
                <div class="central-meta">
                  <div class="editing-info">
							<h1 class="badge badge-primary text-white ml-2"><i class="fa fa-edit"></i> New Question</h1>
							<hr>
						<div class="forum-form">
							  

							<h5 class="f-title"><i class="ti-info-alt"></i>Ask a Question</h5>
              ...
              ?>
								...
								<div class="form-group">	
								  ...
								  <label class="control-label" for="input">Question Heading</label><i class="mtrl-select"></i>
								</div>										
								<div class="form-group">	
                  ...
                  <?php }?>
								...
								<div class="form-group">
                 <hr>	
								  <textarea rows="4" id="editor1" name="message"  required="required"></textarea>
								  <label class="control-label" for="textarea">Describe your problem in deatails</label><i class="mtrl-select"></i>
								</div>
								<div class="submit-btns">
									<button type="reset" class="btn btn-danger">Reset</button>
									<button type="button" id="btn-post" class="btn btn-primary">Post Question</button>
								</div>
							</form>
 ...
 <footer>
     ...
     $("#btn-post").click(function(e) 
  {
    ...
    var Content = CKEDITOR.instances['editor1'].getData();
      ...
      $.ajax({
        url: "<?= base_url('data/ask-question.php');?>", 
        method: "POST", 
        data: {
          'title':title,
          'poster':userid,
