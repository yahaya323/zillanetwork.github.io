...
?>
                 <form class="forms-sample" id="form">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  value="<?php echo htmlentities($row['title']);?>" name="posttitle" id="title" required>
                    </div>
                    <div class="form-group">
                      <input type="hidden" class="form-control"  value="<?php echo htmlentities($row['postid']);?>" name="post_id" id="post_id" required>
                    </div>
                     <div class="form-group">
                      <label for="exampleInputName1">Tags</label>
                      <select class="form-control" name="category" id="tag"  required>
                       <option value="<?php echo htmlentities($row['catid']);?>"><?php echo htmlentities($row['category']);?></option>
                         ...
                         <div class="form-group">
                        <img src="<?php echo htmlentities($row['PostImage']);?>" width="100"/>
                       <a href="change-image.php?pid=<?php echo htmlentities($row['postid']);?>"><button type="button" class="btn btn-primary mr-2">Change Image</button></a>
                    </div>
                    <div class="form-group">
                      <label for="description">Description</label>
                      <textarea class="editor" name="postdescription"  required>
  ...
  <script src="includes/editpost.js"></script>
